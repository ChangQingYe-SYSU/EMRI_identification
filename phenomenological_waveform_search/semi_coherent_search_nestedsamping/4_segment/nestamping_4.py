...
if __name__=="__main__":
    ...
    lb =[0,-5e-8,0.018,0,0,0,0,-22]
    ub = [5e-15,5e-8,0.030,2*np.pi,np.pi,2*np.pi,np.pi/2,-21]
    ...
    path = '/data1/yecq/para_estimation_Michaelson/source_1/fit_phi/2023_6_19_for_paper/segment_4/all/'
