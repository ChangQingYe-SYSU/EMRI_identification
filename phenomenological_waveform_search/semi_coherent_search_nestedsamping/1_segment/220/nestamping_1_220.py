...
if __name__=="__main__":
    ...
    lb =[2e-18,1e-10,0.0160,0,0,0,0,-21.5]
    ub = [8e-18,2e-10,0.0170,2*np.pi,np.pi,2*np.pi,np.pi/2,-21]
    ...
    path = '/data1/yecq/para_estimation_Michaelson/source_1/fit_phi/2023_6_19_for_paper/segment_1/220/'
