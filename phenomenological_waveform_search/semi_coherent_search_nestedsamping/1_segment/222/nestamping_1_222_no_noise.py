...
if __name__=="__main__":
    ...
    lb =[2e-18,5e-11,0.024,0,0,0,0,-21.5]
    ub = [8e-18,2e-10,0.026,2*np.pi,np.pi,2*np.pi,np.pi/2,-21]
    ...
    signal_f = signal_f_not_noise
    
    
    ndim = len(lb)

    path = '/data1/yecq/para_estimation_Michaelson/source_1/fit_phi/2023_6_19_for_paper/segment_1/222/'
    ...
    with dypool.Pool(50, log_likelihood, prior_transform) as pool:
        ...
        psampler.run_nested(dlogz=0.1,checkpoint_file=path + 'nested_run_no_noise.sav')
