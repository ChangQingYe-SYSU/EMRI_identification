...
if __name__=="__main__":
    ...
    lb =[0,-1e-10,0.0160,0,0,0,0,-22]
    ub = [2e-16,2e-10,0.0180,2*np.pi,np.pi,2*np.pi,np.pi/2,-21]
    ...
    path = '/data1/yecq/para_estimation_Michaelson/source_1/fit_phi/2023_6_19_for_paper/segment_2/220/'
