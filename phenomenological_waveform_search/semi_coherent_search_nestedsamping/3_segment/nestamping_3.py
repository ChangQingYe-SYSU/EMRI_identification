...
if __name__=="__main__":
    ...
    lb =[0,-5e-9,0.018,0,0,0,0,-22]
    ub = [5e-16,5e-9,0.029,2*np.pi,np.pi,2*np.pi,np.pi/2,-21]
    ...
    path = '/data1/yecq/para_estimation_Michaelson/source_1/fit_phi/2023_6_19_for_paper/segment_3/all/'
