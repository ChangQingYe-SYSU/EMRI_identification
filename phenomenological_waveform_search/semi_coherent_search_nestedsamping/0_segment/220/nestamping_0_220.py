...
if __name__=="__main__":
    ...
    lb =[2e-18,9e-11,0.0155,0,0,0,0,-21.5]
    ub = [4e-18,1.3e-10,0.0162,2*np.pi,np.pi,2*np.pi,np.pi/2,-21]
    ...
    path = '/data1/yecq/para_estimation_Michaelson/source_1/fit_phi/2023_6_19_for_paper/segment_0/220/'
