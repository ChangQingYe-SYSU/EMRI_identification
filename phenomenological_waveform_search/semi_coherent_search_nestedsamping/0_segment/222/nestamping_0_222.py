...
if __name__=="__main__":
    ...
    lb =[1e-18,1e-10,0.024,0,0,0,0,-21.5]
    ub = [5e-18,3e-10,0.025,2*np.pi,np.pi,2*np.pi,np.pi/2,-21]
    ...
    path = '/data1/yecq/para_estimation_Michaelson/source_1/fit_phi/2023_6_19_for_paper/segment_0/222/'
