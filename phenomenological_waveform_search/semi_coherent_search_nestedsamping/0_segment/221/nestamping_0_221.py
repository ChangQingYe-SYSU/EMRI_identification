...
if __name__=="__main__":
    ...
    lb =[0,0,0.019,0,0,0,0,-22]
    ub = [5e-18,2e-10,0.021,2*np.pi,np.pi,2*np.pi,np.pi/2,-21]
    ...
    path = '/data1/yecq/para_estimation_Michaelson/source_1/fit_phi/2023_6_19_for_paper/segment_0/221/'
